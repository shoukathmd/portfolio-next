export const products = [
  ...
  {
    href: "https://www.perfai.ai/",
    title: "PerfAI",
    description:
      "7+ AI services automate API privacy, governance, contract, performance, release, versioning, and functional testing — delivering secure, enterprise-grade APIs at a fraction of the cost.",
    ...
    content: (
      <div>
        <p>
          PerfAI offers an advanced platform designed to automate performance
          testing for web applications. It provides AI-driven insights to help
          developers optimize their applications for speed and efficiency. The
          platform integrates seamlessly with existing CI/CD pipelines, enabling
  ...
  },
  {
    ...
    title: "APISec",
    description:
      "Shift-left with automated API security testing to find and fix vulnerabilities in the SDLC before they go live.",
    thumbnail: "/images/personal/turing/apisec_1.png",
    images: [
    ...
    content: (
      <div>
        ...
        <p>
          ...
          offering actionable insights to enhance API security. The platform
          integrates seamlessly with CI/CD pipelines, facilitating continuous
          security assessment and compliance. By leveraging advanced AI and
          machine learning algorithms, APIsec delivers precise and efficient
          security testing tailored to modern API architectures.{" "}
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <div>
        <p>
          DCHQ offers a robust platform designed to streamline the deployment,
          management, and scaling of containerized applications. It provides an
          end-to-end solution for container orchestration, leveraging Kubernetes
          and Docker to deliver seamless application lifecycle management. The
          platform simplifies the complexities of deploying applications across
